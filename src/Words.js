...
<ul class="list-group list-group border border-white">
  ...
  <li class="list-group-item border border-white" ><a className="german-list" href="/de/suche">Ein Treffen mit Yannis in New York City</a></li>
</ul>
</ul>
</div>
...
<ul class="list-group list-group-flush border border-white">
  ...
  <li class="list-group-item border border-white"><a className="chinese-list" href="/zh/geisterpferd">鬼马</a></li> 
  <li class="list-group-item border border-white"><a className="chinese-list" href="/zh/suche">疯人</a></li>
  <li class="list-group-item border border-white"><a className="chinese-list" href="/zh/suche">一个变成秃鹫与蝙蝠的梦</a></li>
  <li class="list-group-item border border-white"><a className="chinese-list" href="/zh/suche">岛 1</a></li>
  <li class="list-group-item border border-white"><a className="chinese-list" href="/zh/suche">与Yannis相会于纽约城</a></li>
</ul>
</ul>
...
<div className="container container-fluid d-lg-none">
<div class="chinese-list p-4">
<ul class="list-group list-group-flush border border-white">
